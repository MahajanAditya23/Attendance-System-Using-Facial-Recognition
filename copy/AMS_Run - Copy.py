    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'G:/Project/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"G:/Project/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'G:/Project/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"G:/Project/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main"')
    ...
    def log_in():
        ...
        if username == 'user':
            if password == 'user123':
                ...
                #cs = '"G:/Project/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv"'
                with open("StudentDetails.csv", newline="") as file:
                    reader = csv.reader(file)
                    r = 0
